...
0000000000400efc <phase_2>:
  ...
  400efe:	48 83 ec 28          	sub    $0x28,%rsp   // allocate 28 bytes for stack frame
  400f02:	48 89 e6             	mov    %rsp,%rsi    // use %rsp as second argument
  400f05:	e8 52 05 00 00       	callq  40145c <read_six_numbers>  // Call read_six_numbers
